...
<html lang="en">
    ...
    <body>
        <div class="l-form">
            <form action="http://127.0.0.1:8000/api/register" class="form" method="post">
                <h1 class="form__title">SignIn Up</h1>

                <div class="form__div">
                    <input name="name"type="text" class="form__input" placeholder=" ">
